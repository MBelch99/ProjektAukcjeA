		...
		<div class="card-body">
			<form action="" id="manage-settings">
				<div class="form-group">
					<label for="name" class="control-label">Nazwa systemu</label>
				...
				<center>
					<button class="btn btn-info btn-primary btn-block col-md-2">Zapisz</button>
				</center>
			</form>
		</div>
	</div>
